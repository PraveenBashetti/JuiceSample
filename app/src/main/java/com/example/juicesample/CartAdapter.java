...
import static com.example.juicesample.CartActivity.grandTotal;
import static com.example.juicesample.CartActivity.grandTotalplus;
import static com.example.juicesample.CartActivity.temparraylist;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final CartAdapter.ViewHolder holder, final int position) {
        ...
        requestOptions.placeholder(R.drawable.apple);
        requestOptions.error(R.drawable.apple);
