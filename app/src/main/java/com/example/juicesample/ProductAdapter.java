...
import static com.example.juicesample.SubMenuJuice.arrayList;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ProductAdapter.ViewHolder viewHolder, final int i) {
        ...
        viewHolder.Price.setText(productsArray.get(i).price);
...
//
                       ...
                       SubMenuJuice.cart_count = cartModels.size();
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            Price=itemView.findViewById(R.id.android_gridview_Name);
